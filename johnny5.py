...
__author__ = "Enrique Moran"
__coauthor = "Ilia Gruntal"
__version__ = "v1.4.1"
...
def send_welcome_msg(message):
    ...
    msg_zero = f"---- Johnny5 version: {__version__} ----"
    msg_one = "\n\nThis bot allows you to remotely control a computer through shell commands."
    ...
    msg_three = f"\nSent files are at: *{SHARED_FOLDER}*"
    msg_four = "\nYou can download files by using" + \
               "\n*getfile /home/user/Desktop/file.txt*"
    welcome_msg = msg_zero + msg_one + msg_two + msg_three + msg_four
    
    with open("./pics/johnny5.png", "rb") as photo:
        bot.send_photo(message.chat.id, photo, welcome_msg, parse_mode="markdown")
